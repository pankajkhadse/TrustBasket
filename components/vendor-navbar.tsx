...
import { Bell, Search, Menu, User, Settings, LogOut, ShoppingCart, Package, Users, BarChart3 } from "lucide-react"
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <Input type="text" placeholder="Search products, suppliers..." className="pl-10 pr-4 w-full" />
            </div>
          </div>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="space-y-2 p-2">
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-xs text-gray-600">Order #ORD-004 from Fresh Veggies Co.</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-lg">
                    <p className="text-sm font-medium">Payment confirmed</p>
                    <p className="text-xs text-gray-600">₹1,250 received for order #ORD-001</p>
                  </div>
                  <div className="p-3 bg-orange-50 rounded-lg">
                    <p className="text-sm font-medium">Low stock alert</p>
                    <p className="text-xs text-gray-600">Onions running low in inventory</p>
                  </div>
                </div>
              </DropdownMenuContent>
            </DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-xs leading-none text-muted-foreground">rajesh@streetfood.com</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuItem>
