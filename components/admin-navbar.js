...
import { Bell, Search, Menu, User, Settings, LogOut, Users, Package, BarChart3, Shield } from "lucide-react"
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <Input type="text" placeholder="Search users, orders..." className="pl-10 pr-4 w-full" />
            </div>
          </div>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="space-y-2 p-2">
                  <div className="p-3 bg-red-50 rounded-lg">
                    ...
                    <p className="text-xs text-gray-600">Order #ORD-8901 needs attention</p>
                  </div>
                  <div className="p-3 bg-yellow-50 rounded-lg">
                    <p className="text-sm font-medium">New vendor registration</p>
                    <p className="text-xs text-gray-600">Tasty Bites pending approval</p>
                  </div>
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm font-medium">System maintenance</p>
                    <p className="text-xs text-gray-600">Scheduled for tonight 2 AM</p>
                  </div>
                </div>
              </DropdownMenuContent>
            </DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-xs leading-none text-muted-foreground">admin@streetserve.com</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuItem>
